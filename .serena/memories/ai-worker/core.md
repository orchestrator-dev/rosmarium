# rosmarium-ai-worker — Core

Path: `apps/rosmarium-ai-worker/`  
Package: `rosmarium-ai-worker`  
Runtime: Python 3.12, FastAPI, uvicorn on port **8001**

## Entry point
`src/rosmarium_ai_worker/main.py` — FastAPI app, registers routers

## Config
`src/rosmarium_ai_worker/config.py` — pydantic-settings class  
