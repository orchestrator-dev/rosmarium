# Cortex CMS: Multi-Tenancy Model

Cortex CMS v0.10.0 introduces PostgreSQL namespace-based multi-tenancy.

## Data Isolation Strategy

Instead of relying heavily on Row-Level Security (RLS) which can degrade performance in deeply nested graph queries, Cortex utilizes **Schema-based Isolation**:
