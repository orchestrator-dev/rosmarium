...
async def test_empty_fields_skipped() -> None:
    ...
    with patch("rosmarium_ai_worker.workers.embedding_worker.get_provider") as mock_get_prov, \
         patch("rosmarium_ai_worker.workers.embedding_worker.get_chunker") as mock_get_chunker, \
         patch("rosmarium_ai_worker.workers.embedding_worker.get_pool") as mock_get_pool:
...
async def test_full_pipeline_happy_path(mock_pool: AsyncMock) -> None:
    ...
    with patch("rosmarium_ai_worker.workers.embedding_worker.get_chunker", return_value=mock_chunker), \
         patch("rosmarium_ai_worker.workers.embedding_worker.get_provider", return_value=mock_provider), \
         patch("rosmarium_ai_worker.workers.embedding_worker.get_pool", return_value=mock_pool), \
         patch("rosmarium_ai_worker.workers.embedding_worker.index_manager", mock_index):
