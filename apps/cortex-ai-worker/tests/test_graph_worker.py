...
from cortex_ai_worker.workers.graph_worker import AnalyticsJobPayload, process_analytics_job
...
async def test_process_analytics_job_happy_path(mock_pool: AsyncMock) -> None:
    ...
    with patch("cortex_ai_worker.workers.graph_worker.get_pool", return_value=mock_pool), \
         patch("cortex_ai_worker.workers.graph_worker.analytics_engine", mock_engine):
