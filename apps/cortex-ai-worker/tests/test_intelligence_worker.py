...
from rosmarium_ai_worker.intelligence.tagger import TagResult
from rosmarium_ai_worker.workers.intelligence_worker import (
...
class TestIntelligenceWorker:
    ...
    async def test_runs_all_requested_operations(self) -> None:
        ...
        with (
            patch("rosmarium_ai_worker.workers.intelligence_worker.auto_tagger") as mock_tagger,
            patch("rosmarium_ai_worker.workers.intelligence_worker.ner_extractor") as mock_ner,
            patch("rosmarium_ai_worker.workers.intelligence_worker.get_pool", new=get_pool),
        ):
    ...
    async def test_skips_empty_text_gracefully(self) -> None:
        ...
        with patch("rosmarium_ai_worker.workers.intelligence_worker.auto_tagger") as mock_tagger:
