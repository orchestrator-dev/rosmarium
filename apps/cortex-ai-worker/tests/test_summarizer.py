...
from cortex_ai_worker.intelligence.summarizer import ContentSummarizer, _count_words
...
class TestContentSummarizer:
    ...
    async def test_calls_ollama_with_brief_prompt(self, summarizer: ContentSummarizer) -> None:
        ...
        with patch("cortex_ai_worker.intelligence.summarizer.httpx.AsyncClient") as mock_client:
