...
// .wrangler/tmp/bundle-qhqUx0/checked-fetch.js
...
// .wrangler/tmp/bundle-qhqUx0/strip-cf-connecting-ip-header.js
...
// src/cache.ts
var getCacheKey = /* @__PURE__ */ __name((url, idOrPath, options) => {
  const locale = options?.locale || "default";
  const branch = options?.branch || "main";
  return `content:${locale}:${branch}:${idOrPath}`;
}, "getCacheKey");
var getCachedContent = /* @__PURE__ */ __name(async (kv, key) => {
  const data = await kv.get(key, "json");
  return data;
}, "getCachedContent");
var cacheContent = /* @__PURE__ */ __name(async (kv, key, content, ttl = 3600) => {
  await kv.put(key, JSON.stringify(content), { expirationTtl: ttl });
}, "cacheContent");
var invalidateCache = /* @__PURE__ */ __name(async (kv, key) => {
  await kv.delete(key);
}, "invalidateCache");
...
router.post("/internal/invalidate", async (c) => {
  ...
  if (id) {
    const key2 = getCacheKey("", id, { locale, branch });
    await invalidateCache(c.env.CONTENT_CACHE, key2);
  }
...
// ../../node_modules/.pnpm/wrangler@3.114.17_@cloudflare+workers-types@4.20260531.1/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../node_modules/.pnpm/wrangler@3.114.17_@cloudflare+workers-types@4.20260531.1/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-qhqUx0/middleware-insertion-facade.js
...
// ../../node_modules/.pnpm/wrangler@3.114.17_@cloudflare+workers-types@4.20260531.1/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-qhqUx0/middleware-loader.entry.ts
